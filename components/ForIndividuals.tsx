...
export default function ForIndividuals() {
  ...
  // Add this state to track successful form submission
  ...
  // Update the handleSubmit function to use Web3Forms API
  const handleSubmit = (e: React.FormEvent) => {
    ...
    formDataObj.append("access_key", "e0d08ccb-aa34-4b38-9068-8531ab111d36");
    formDataObj.append(
      "subject",
      formData.subject || "New Message from AnamVR Website"
    );
    formDataObj.append("name", `${formData.firstName} ${formData.lastName}`);
    formDataObj.append("email", formData.email);
    formDataObj.append("message", formData.message);
    formDataObj.append("newsletter", formData.newsletter ? "Yes" : "No");
                    ...
                    <div className="text-[#545454]">
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          className="rounded text-[#7745b8] focus:ring-[#7745b8]"
                        />
